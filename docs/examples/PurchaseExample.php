...
$data = array(
    'payment' => array(
        ...
        'url' => array(
            'authorize' => 'http://example.com/docs/examples/CallbackEndpointAuthorizeExample.php', // The url to the Authorize Callback Resource
            'settle'    => 'http://example.com/docs/examples/CallbackEndpointSettlementExample.php', // The url to the Settlement Callback Resource
